        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Хотите легализоваться в Екатеринбурге? Поможем с РВП от 1500₽, ВНЖ от 3000₽, гражданством РФ от 3000₽ или защитим при задержании полицией. С 2015 года оформили 10 000+ статусов.
            </p>
